...
export const typeDefs = {
	...
	definitions: [
		...
		},
		{
			...
			loc: { start: 537, end: 707 },
		},
		{
			kind: "ObjectTypeDefinition",
			name: { kind: "Name", value: "Query", loc: { start: 713, end: 718 } },
			interfaces: [],
			directives: [],
			fields: [],
			loc: { start: 708, end: 718 },
		},
		{
			kind: "ObjectTypeDefinition",
			name: { kind: "Name", value: "Stock", loc: { start: 724, end: 729 } },
			interfaces: [],
			directives: [],
			fields: [
				{
			...
			loc: { start: 719, end: 761 },
		},
		{
			kind: "ObjectTypeDefinition",
			name: { kind: "Name", value: "Track", loc: { start: 767, end: 772 } },
			interfaces: [],
			directives: [],
			fields: [
				{
					kind: "FieldDefinition",
					name: { kind: "Name", value: "name", loc: { start: 777, end: 781 } },
					arguments: [],
					type: {
						kind: "NonNullType",
						type: {
					...
					directives: [],
					loc: { start: 777, end: 790 },
				},
				{
					kind: "FieldDefinition",
					name: { kind: "Name", value: "url", loc: { start: 793, end: 796 } },
					arguments: [],
					type: {
						kind: "NamedType",
						name: {
			...
			loc: { start: 762, end: 821 },
		},
		{
			kind: "ObjectTypeDefinition",
			name: { kind: "Name", value: "Variant", loc: { start: 827, end: 834 } },
			interfaces: [],
			directives: [],
			fields: [
				{
					kind: "FieldDefinition",
					name: { kind: "Name", value: "name", loc: { start: 839, end: 843 } },
					arguments: [],
					type: {
						kind: "NonNullType",
						type: {
				...
				{
					kind: "FieldDefinition",
					name: { kind: "Name", value: "price", loc: { start: 855, end: 860 } },
					arguments: [],
					type: {
						kind: "NonNullType",
						type: {
					...
					directives: [],
					loc: { start: 855, end: 866 },
				},
				{
					kind: "FieldDefinition",
					name: { kind: "Name", value: "stock", loc: { start: 869, end: 874 } },
					arguments: [],
					type: {
						kind: "NonNullType",
						type: {
