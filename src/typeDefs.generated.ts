...
export const typeDefs = {
	...
	definitions: [
		...
		},
		{
			...
			loc: { start: 1388, end: 1478 },
		},
		{
			kind: "ObjectTypeDefinition",
			name: { kind: "Name", value: "Track", loc: { start: 1485, end: 1490 } },
			interfaces: [],
			directives: [],
			fields: [
				{
				...
				{
					kind: "FieldDefinition",
					name: { kind: "Name", value: "url", loc: { start: 1511, end: 1514 } },
					arguments: [],
					type: {
						kind: "NamedType",
						name: {
				...
				},
				{
					...
					type: {
						...
						loc: { start: 1533, end: 1537 },
					},
					directives: [],
					loc: { start: 1525, end: 1537 },
				},
			],
			loc: { start: 1480, end: 1539 },
		},
		{
			kind: "ObjectTypeDefinition",
			name: { kind: "Name", value: "Product", loc: { start: 1546, end: 1553 } },
			interfaces: [],
			directives: [],
			fields: [
				{
					kind: "FieldDefinition",
					name: { kind: "Name", value: "id", loc: { start: 1558, end: 1560 } },
					arguments: [],
					type: {
						kind: "NonNullType",
						type: {
				...
				},
				{
					...
					type: {
						...
						loc: { start: 1661, end: 1670 },
					},
					directives: [],
					loc: { start: 1651, end: 1670 },
				},
				{
					kind: "FieldDefinition",
					name: {
				...
				},
				{
					...
					directives: [],
					loc: { start: 1693, end: 1714 },
				},
			],
			loc: { start: 1541, end: 1716 },
		},
		{
			...
			values: [
				...
				},
				{
					...
					name: {
						kind: "Name",
						value: "CANCELLED",
						loc: { start: 1780, end: 1789 },
					},
					directives: [],
					loc: { start: 1780, end: 1789 },
				},
			],
			loc: { start: 1718, end: 1791 },
		},
		{
			kind: "EnumTypeDefinition",
			name: {
				kind: "Name",
				value: "VariantEnum",
				loc: { start: 1798, end: 1809 },
			},
			directives: [],
			values: [
				{
					kind: "EnumValueDefinition",
					name: { kind: "Name", value: "cd", loc: { start: 1814, end: 1816 } },
					directives: [],
					loc: { start: 1814, end: 1816 },
				},
				{
					kind: "EnumValueDefinition",
					name: { kind: "Name", value: "lp", loc: { start: 1819, end: 1821 } },
					directives: [],
					loc: { start: 1819, end: 1821 },
				},
			],
			loc: { start: 1793, end: 1823 },
		},
	],
	loc: { start: 0, end: 1824 },
