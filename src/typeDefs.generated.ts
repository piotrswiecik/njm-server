...
export const typeDefs = {
	...
	definitions: [
				...
				},
				{
					...
					type: {
						...
						name: {
							kind: "Name",
							value: "Category",
							loc: { start: 1211, end: 1219 },
						},
						loc: { start: 1211, end: 1219 },
					},
					directives: [],
					loc: { start: 1186, end: 1219 },
				},
			],
			loc: { start: 1127, end: 1221 },
		},
		{
			kind: "ObjectTypeExtension",
			name: { kind: "Name", value: "Query", loc: { start: 1235, end: 1240 } },
			interfaces: [],
			directives: [],
			fields: [
				{
					...
					directives: [],
					loc: { start: 1245, end: 1287 },
				},
			],
			loc: { start: 1223, end: 1289 },
		},
		{
			kind: "ObjectTypeDefinition",
			name: { kind: "Name", value: "Query", loc: { start: 1295, end: 1300 } },
			interfaces: [],
			directives: [],
			fields: [],
		...
		{
			kind: "ObjectTypeDefinition",
			name: { kind: "Name", value: "Artist", loc: { start: 1321, end: 1327 } },
			interfaces: [],
			directives: [],
			fields: [
				{
		...
		},
		{
			...
			fields: [
				...
				},
				{
						...
						},
						{
							...
							type: {
								...
								name: {
									kind: "Name",
									value: "String",
									loc: { start: 1445, end: 1451 },
								},
								loc: { start: 1445, end: 1451 },
							},
							directives: [],
							loc: { start: 1438, end: 1451 },
						},
					],
					type: {
						kind: "NonNullType",
					...
					directives: [],
					loc: { start: 1393, end: 1465 },
				},
			],
			loc: { start: 1349, end: 1467 },
		},
		{
			kind: "ObjectTypeDefinition",
