	...
	definitions: [
		...
		},
		{
			...
			name: {
				kind: "Name",
				value: "VariantEnum",
				loc: { start: 2235, end: 2246 },
			},
			directives: [],
			values: [
				{
					kind: "EnumValueDefinition",
					name: { kind: "Name", value: "cd", loc: { start: 2251, end: 2253 } },
					directives: [],
					loc: { start: 2251, end: 2253 },
				},
				{
					kind: "EnumValueDefinition",
					name: { kind: "Name", value: "lp", loc: { start: 2256, end: 2258 } },
					directives: [],
					loc: { start: 2256, end: 2258 },
				},
			],
			loc: { start: 2230, end: 2260 },
		},
	],
	loc: { start: 0, end: 2261 },
